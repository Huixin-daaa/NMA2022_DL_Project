function generate_test_pair(startpointl1,endpointl1,thetal1,startpointl2,endpointl2,thetal2,top_arrow_line, bottom_arrow_line,linewidth)
% startpoint : [x y]
% endpoint   : [x y]
...
plotarrowoutward(startpointl1,top_arrow_line,theta1,theta2,linewidth);
theta2 = atan((startpointl1(1) - endpointl1(1))/((startpointl1(2) - endpointl1(2))));
plotarrowoutward(endpointl1,top_arrow_line,theta1,theta2,linewidth);
xlim([0 256]);
ylim([0 256]);
